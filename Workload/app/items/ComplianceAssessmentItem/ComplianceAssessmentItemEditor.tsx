...
/**
 * Different views that are available for the ComplianceAssessment item
 */
...
export function ComplianceAssessmentItemEditor(props: PageProps) {
  ...
  const [currentDefinition, setCurrentDefinition] = useState<ComplianceAssessmentItemDefinition>({});
  ...
  async function loadDataFromUrl(pageContext: ContextProps, pathname: string): Promise<void> {
    ...
    setIsLoading(true);
    var LoadedItem: ItemWithDefinition<ComplianceAssessmentItemDefinition> = undefined;
    if (pageContext.itemObjectId) {
      // for Edit scenario we get the itemObjectId and then load the item via the workloadClient SDK
      try {
        LoadedItem = await getWorkloadItem<ComplianceAssessmentItemDefinition>(
          workloadClient,
  ...
  async function saveItem() {
    ...
    try {
      successResult = await saveWorkloadItem<ComplianceAssessmentItemDefinition>(
        workloadClient,
  ...
  const EmptyViewWrapper = () => {
    ...
    return (
      <ComplianceAssessmentItemEmptyView
  ...
  const views = [
    ...
    },
    {
      ...
      component: (
      <ComplianceAssessmentItemDefaultView
        workloadClient={workloadClient}
        item={item}
  ...
  return (
    <ItemEditor
      isLoading={isLoading}
      loadingMessage={t("ComplianceAssessmentItemEditor_Loading", "Loading item...")}
      ribbon={(context) => (
